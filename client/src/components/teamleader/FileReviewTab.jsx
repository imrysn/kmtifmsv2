        ...
        <div className={`tl-stat-card green clickable ${selectedStatusFilter === 'approved' ? 'active' : ''}`} onClick={() => handleStatusFilter('approved')}>
          ...
          <div className="tl-stat-bottom">
            ...
            <div className="tl-stat-icon-box green">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none"><path d="M9 12L11 14L15 10M21 12C21 16.97 16.97 21 12 21C7.03 21 3 16.97 3 12C3 7.03 7.03 3 12 3C16.97 3 21 7.03 21 12Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
            </div>
          </div>
        </div>
        ...
        <div className={`tl-stat-card yellow clickable ${selectedStatusFilter === 'pending' ? 'active' : ''}`} onClick={() => handleStatusFilter('pending')}>
          ...
          <div className="tl-stat-bottom">
            ...
            <div className="tl-stat-icon-box yellow">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none"><path d="M12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="M12 6V12L16 14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
            </div>
          </div>
        </div>
        ...
        <div className={`tl-stat-card red clickable ${selectedStatusFilter === 'rejected' ? 'active' : ''}`} onClick={() => handleStatusFilter('rejected')}>
          ...
          <div className="tl-stat-bottom">
            ...
            <div className="tl-stat-icon-box red">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none"><path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM13 17H11V15H13V17ZM13 13H11V7H13V13Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
            </div>
          </div>
        </div>
      </div>
