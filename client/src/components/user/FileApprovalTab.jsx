const FileApprovalTab = ({ 
  ...
  const FileItem = ({ file, showWithdraw = false }) => (
    <div className="approval-file-item">
      ...
      <div className="file-status-section">
        {file.status === 'final_approved' ? (
          <span className="status-badge approved">
            <span className="status-icon">✓</span> Approved
          </span>
        ) : file.current_stage.includes('pending') ? (
          <span className="status-badge pending">
            <span className="status-icon">⏱</span> Pending Review
          </span>
        ) : (
      ...
      <div className="file-actions-section">
        ...
        >
          <span className="action-icon">👁</span> Details
        </button>
      </div>
    </div>
  );
